...
namespace ROC.Module.Defs
{
    internal static class Vector4Defs
    {
        ...
        static int Create(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector4(l_x, l_y, l_z, l_w), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Vector4(vec4.Zero), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Vector4(vec4.Ones), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Vector4(vec4.UnitX), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Vector4(vec4.UnitY), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Vector4(vec4.UnitZ), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Vector4(vec4.UnitW), ms_vector4Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Vector4 l_vecA) || !l_reader.ReadObject(out Vector4 l_vecB))
            {
                l_reader.PushBoolean(false);
                return 1;
            }

            l_reader.PushNumber(vec4.Distance(l_vecA.m_vector, l_vecB.m_vector));
            return 1;
        }
        ...
        static int Dot(IntPtr p_state)
        {
            ...
            l_reader.PushNumber(vec4.Dot(l_vecA.m_vector, l_vecB.m_vector));
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Vector4 l_vecA) || !l_reader.ReadObject(out Vector4 l_vecB) || !l_reader.ReadNumber(out float l_alpha))
            {
                l_reader.PushBoolean(false);
                return 1;
            }

            l_reader.PushObject(new Vector4(vec4.Lerp(l_vecA.m_vector, l_vecB.m_vector, l_alpha)), ms_vector4Type);
            return 1;
        }
        ...
        static int Reflect(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector4(vec4.Reflect(l_vecA.m_vector, l_vecB.m_vector)), ms_vector4Type);
            return 1;
        }
        ...
        static int Add(IntPtr p_state)
        {
            ...
            {
                l_reader.PushObject(new Vector4(l_vec0.m_vector + (float)l_val0), ms_vector4Type);
                return 1;
            }

            if(l_valA is Vector4 l_vec1 && l_valB is long l_val1)
            {
                l_reader.PushObject(new Vector4(l_vec1.m_vector + l_val1), ms_vector4Type);
                return 1;
            }

            if(l_valA is Vector4 l_vec2 && l_valB is Vector4 l_val2)
            {
                l_reader.PushObject(new Vector4(l_vec2.m_vector + l_val2.m_vector), ms_vector4Type);
                return 1;
            }
            ...
            {
                l_reader.PushObject(new Vector4((float)l_val3 + l_vec3.m_vector), ms_vector4Type);
                return 1;
            }

            if(l_valA is long l_val4 && l_valB is Vector4 l_vec4)
            {
                l_reader.PushObject(new Vector4(l_val4 + l_vec4.m_vector), ms_vector4Type);
                return 1;
            }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Vector4 l_vec))
            {
                l_reader.PushBoolean(false);
                return 1;
            }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Vector4 l_vec) || !l_reader.ReadNumber(out float l_val))
                return 0;
        ...
        static int GetW(IntPtr p_state)
        {
            ...
            l_reader.PushNumber(l_vec.m_vector.w);
            return 1;
        }
        ...
        static int Normalized(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector4(l_vec.m_vector.Normalized), ms_vector4Type);
            return 1;
        }
    }
}
