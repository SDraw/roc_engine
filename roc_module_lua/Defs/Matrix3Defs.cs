...
namespace ROC.Module.Defs
{
    internal static class Matrix3Defs
    {
        ...
        static int Create(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Matrix3(new mat3(
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Matrix3(mat3.Zero), ms_matrix3Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            l_reader.PushObject(new Matrix3(mat3.Identity), ms_matrix3Type);
            return 1;
        }
        ...
        static int Add(IntPtr p_state)
        {
            ...
            {
                l_reader.PushObject(new Matrix3(l_mat0.m_matrix + (float)l_val0), ms_matrix3Type);
                return 1;
            }
            if(p_objA is Matrix3 l_mat1 && l_objB is long l_val1)
            {
                l_reader.PushObject(new Matrix3(l_mat1.m_matrix + l_val1), ms_matrix3Type);
                return 1;
            }
            if(p_objA is Matrix3 l_mat2 && l_objB is Matrix3 l_val2)
            {
                l_reader.PushObject(new Matrix3(l_mat2.m_matrix + l_val2.m_matrix), ms_matrix3Type);
                return 1;
            }
            ...
            {
                l_reader.PushObject(new Matrix3((float)l_val4 + l_mat4.m_matrix), ms_matrix3Type);
                return 1;
            }
            if(p_objA is long l_val5 && p_objA is Matrix3 l_mat5)
            {
                l_reader.PushObject(new Matrix3(l_val5 + l_mat5.m_matrix), ms_matrix3Type);
                return 1;
            }
        ...
        static int Multiply(IntPtr p_state)
        {
            ...
            {
                l_reader.PushObject(new Vector3(l_mat3.m_matrix * l_val3.m_vector), ms_vector3Type);
                return 1;
            }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Matrix3 l_mat))
            {
                l_reader.PushBoolean(false);
                return 1;
            }
        ...
        static int Inverse(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Matrix3(l_mat.m_matrix.Inverse), ms_matrix3Type);
            return 1;
        }
        ...
        static int Adjugate(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Matrix3(l_mat.m_matrix.Adjugate), ms_matrix3Type);
            return 1;
        }
        ...
        static int Transpose(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Matrix3(l_mat.m_matrix.Transposed), ms_matrix3Type);
            return 1;
        }
        ...
        static int GetColumn0(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector3(l_mat.m_matrix.Column0), ms_vector3Type);
            return 1;
        }
        static int SetColumn0(IntPtr p_state)
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Matrix3 l_mat) || !l_reader.ReadObject(out Vector3 l_vec))
                return 0;
        ...
        static int GetColumn1(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector3(l_mat.m_matrix.Column1), ms_vector3Type);
            return 1;
        }
        ...
        static int GetColumn2(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector3(l_mat.m_matrix.Column2), ms_vector3Type);
            return 1;
        }
        ...
        static int GetRow0(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector3(l_mat.m_matrix.Row0), ms_vector3Type);
            return 1;
        }
        ...
        static int GetRow1(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector3(l_mat.m_matrix.Row1), ms_vector3Type);
            return 1;
        }
        ...
        static int GetRow2(IntPtr p_state)
        {
            ...
            l_reader.PushObject(new Vector3(l_mat.m_matrix.Row2), ms_vector3Type);
            return 1;
        }
        ...
        {
            ArgReader l_reader = new ArgReader(p_state);
            if(!l_reader.ReadObject(out Matrix3 l_mat) || !l_reader.ReadNumber(out float l_val))
                return 0;
